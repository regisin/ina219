...
simple-auto-gain.o: ina219.o
	g++ -o ./build/lib/simple-auto-gain.o -c ./simple-auto-gain.c
	g++ -o ./build/examples/simple-auto-gain ./build/lib/simple-auto-gain.o ./build/lib/ina219.o

auto-gain-high-resolution.o: ina219.o
	g++ -o ./build/lib/auto-gain-high-resolution.o -c ./auto-gain-high-resolution.c
...
manual-gain-high-resolution.o: ina219.o
	g++ -o ./build/lib/manual-gain-high-resolution.o -c ./manual-gain-high-resolution.c
